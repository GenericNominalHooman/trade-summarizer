                                                    ...
                                                    <form class="w-full">
                                                        ...
                                                        <div class="flex flex-wrap -mx-3 mb-6">
                                                            <div class="w-full px-3">
                                                                ...
                                                                <textarea wire:model="new_summary" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" rows="12" placeholder="AI-generated summary will appear here" readonly></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <form class="w-full">
                                                            ...
                                                            <div class="flex flex-wrap -mx-3 mb-6">
                                                                <div class="w-full px-3">
                                                                    ...
                                                                    <textarea wire:model="selected_summary" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" rows="12" placeholder="AI-generated summary will appear here" readonly></textarea>
                                                                </div>
                                                            </div>
